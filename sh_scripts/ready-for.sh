...
#
# Version 9.2: 2023-03-27 ready-for.sh
#   * Add support for getting files from nginx (instead of apache2)
#
#===============================================================================
VERSION=9.2
...
LFCM="https://cm.lf.training"
UPGRADE="https://prep.lf.training"
...
#===============================================================================
# Screen Scrape HTML from web browser index
# For Apache print $8, for nginx it should be $4
get_index_filename() {
    local REGEX=$1
    # shellcheck disable=SC2086
    awk -F\" "/${REGEX:?}/ {print \$4}"
...
get_activity_file() {
    ...
    FILE=$(get_file "$ACTIVITY" \
        | get_index_filename "${VER:+_V${VER#V}_}$KIND" \
...
FALLBACK=(
    ...
    [Fedora-37]="Fedora-36 CentOS"
    [Fedora-999]="Fedora-36 Fedora"
    [LinuxMint]="Ubuntu"
    ...
    [openSUSE-15.4]="openSUSE-15.3 openSUSE"
    [openSUSE-999]="openSUSE-15.4 openSUSE"
    [SLES]="openSUSE"
...
RECOMMENDS[LFD301]="iptraf-ng gnome-system-monitor yelp"
...
RECOMMENDS[CentOS-6_LFD301]="-iptraf-ng iptraf"
...
#===============================================================================
# Extra requirements for LFD441
#===============================================================================
TITLE[LFD441]="Security and the Linux Kernel"
WEBPAGE[LFD441]="$LFDTRAINING/security-and-linux-kernel-lfd441"
PREREQ[LFD441]="LFD420 LFD430"
BOOT[LFD441]=128	# Room for 2 more kernels
DISK[LFD441]=9
#VMOKAY[LFD441]="$VMPREFERRED"
#-------------------------------------------------------------------------------
PACKAGES[LFD441]="[LFD420] @ebpf @kernel @kdump"
PACKAGES[Ubuntu_LFD441]="policycoreutils"
#RECOMMENDS[Ubuntu_LFD441]="libdw-dev libaudit-dev libelf-dev binutils-dev
...
#===============================================================================
TITLE[LFS164]="Introduction to Open Source Networking Technologies"
WEBPAGE[LFS164]="$LFSTRAINING/introduction-to-open-source-networking-technologies"
INPERSON[LFS164]=n
VIRTUAL[LFS164]=n
SELFPACED[LFS164]=y
MOOC[LFS164]=edX
...
#===============================================================================
TITLE[LFS203]="Linux for Cloud Technicians Essentials"
WEBPAGE[LFS203]="$LFSTRAINING/linux-for-cloud-technicians-essentials-lfs203"
INPERSON[LFS203]=n
VIRTUAL[LFS203]=n
SELFPACED[LFS203]=y
INSTR_LED_CLASS[LFS203]="LFS303"
DISK[LFS203]="1"
#-------------------------------------------------------------------------------
COPYPACKAGES[LFS203]="LFS211"
...
RECOMMENDS[openSUSE-15.3_LFS211]="zenmap"
RECOMMENDS[openSUSE-15.4_LFS211]="-zenmap"
...
#-------------------------------------------------------------------------------
PACKAGES[LFW111]="bash ca-certificates curl openssl"
